...
const icons = {
  ...
  refresh: {
    viewBox: "0 0 20 20",
    body: `<path d="M17.5 10a7.5 7.5 0 1 1-7.5-7.5c2.1 0 4.11 0.83 5.62 2.28L17.5 6.67M17.5 2.5v4.17h-4.17" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>`,
  },
  reset: {
    viewBox: "0 0 20 20",
